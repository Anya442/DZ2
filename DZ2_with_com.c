...
int main(void){
	...
	system("dot S1.dot -Tbmp -o S1.bmp"); //graphiz рисует визуализацию по файлу, указать путь до файла
	ShellExecuteA(GetDesktopWindow(),"open","C:/Users/Аня/Documents/dz//Project1/S1.bmp",NULL,NULL,SW_SHOW); //graphiz открывает картинку,
